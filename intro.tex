...
coordinate updates that can be either synchronous or asynchronous.
...
The \pkg~package can be access from GitHub at \url{https://github.com/uclaopt/MOTAC}. \commwy{add a shorcut for the link} The package runs on Linux, Mac, and Windows operating systems.
