...
and Nonnegative matrix factorization. \commzp{Brent, fixed wording.}
...
Therefore, our codes  are short, clean, and thus easy to read and modify. \commzp{Brent will fix this.}
...
%Software packages based on operator splitting  .... include TFOCS \cite{BeckerCandesGrant2011_TemplatesConvex} .....
